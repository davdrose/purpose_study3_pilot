(function () {
  ...
  class InterbreedingLineageIntroductionPlugin {
    ...
    render() {
      ...
      const purposeGuide = '<article class="g0-evidence-guide purpose-guide"><span>G0 documented purpose</span><p class="g0-purpose-statement">' + this.lineage.purposeRoles.baselineStatement + '</p><p>The orange line rises when researchers find stronger evidence that the trait serves a different purpose than it served at G0.</p></article>';
