(function (global) {
  ...
  function questionText(question, item) {
    return question.template
      .replaceAll("{singular}", item.singular);
  }

  class ConsentPlugin {
    static info = { name: "animal-goodness-consent", version: "8.0.0", parameters: {}, data: {} };
  ...
  class IntroductionPlugin {
    static info = { name: "animal-goodness-introduction", version: "8.0.0", parameters: {}, data: {} };
    ...
    trial(displayElement) {
      ...
      displayElement.innerHTML = studyFrame(
        ...
        '<div class="instructions-body">' +
          '<p>You will see <strong>four different animals</strong>, one at a time.</p>' +
          '<p>For each animal, you will first see its picture and name. You will then answer five questions about that animal. Each question will appear on its own screen.</p>' +
  ...
  class ItemIntroductionPlugin {
    ...
    trial(displayElement, trial) {
      ...
      displayElement.innerHTML = studyFrame(
        ...
        "</figure>" +
        '<footer class="card-footer"><span>You will answer five questions about this ' + escapeHtml(item.singular) + ".</span>" +
  ...
  class DemographicsPlugin {
    static info = { name: "animal-goodness-demographics", version: "8.0.0", parameters: {}, data: {} };
