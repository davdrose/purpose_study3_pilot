(function () {
  ...
  function stimulusTrial(assignment, stimulus, construct, trialIndex, step, total) {
    const statement = window.EssenceStudy.Stimuli.statement(stimulus, construct);
  ...
  function generalQuestion(assignment, construct, step, total) {
    const purpose = construct === "purpose";
  ...
  function fatal(message) {
    return '<main class="study-shell"><section class="study-card study-card--compact"><p class="eyebrow">Unable to open</p><h1>The experiment could not be started</h1><p class="lede">' + escapeHtml(message) + '</p><p class="technical-note">Please reopen index.html from the complete essence_vs_temp_v11 folder.</p></section></main>';
  }
