(function () {
  ...
  class InterbreedingConsentPlugin {
    static info = { name: "interbreeding-consent", version: "38.0.0", parameters: {}, data: {} };
  ...
  class InterbreedingDemographicsPlugin {
    static info = { name: "interbreeding-demographics", version: "38.0.0", parameters: {}, data: {} };
  ...
  class InterbreedingSavePlugin {
    static info = { name: "interbreeding-save", version: "38.0.0", parameters: {}, data: {} };
