(function () {
  ...
  function readParams() {
    ...
    return {
      ...
      mode: get("mode"),
      console_condition: get("condition"),
      cell: get("cell"),
  ...
  function buildAssignment() {
    ...
    if (p.mode && ["single", "sequence", "sandbox", "production"].indexOf(p.mode) < 0) warnInvalid("mode", p.mode);
    ...
    const assignment = {
      ...
      console_condition: p.console_condition || "complete_2x2_sequence",
