(function () {
  ...
  class FossilConsentPlugin {
    static info = { name: "fossil-consent", version: "27.0.0", parameters: {}, data: {} };
  ...
  class FossilStudyIntroductionPlugin {
    static info = { name: "fossil-study-introduction", version: "27.0.0", parameters: {}, data: {} };
    ...
    trial(displayElement) {
      ...
      displayElement.innerHTML = '<main class="prestudy-screen introduction-flow"><section class="prestudy-card study-introduction-card">' +
        ...
        '<div class="study-introduction-body">' +
          '<p class="introduction-lead">You will examine fossil records showing how one animal species evolved into another.</p>' +
          '<p>After examining the fossil records, you will decide whether a fossil sample belongs to an animal species.</p>' +
        '</div>' +
        '<footer class="action-only-footer"><button type="button" class="primary-button" data-begin-study>Begin the study <span aria-hidden="true">→</span></button></footer>' +
      '</section></main>';
  ...
  class FossilDemographicsPlugin {
    static info = { name: "fossil-demographics", version: "27.0.0", parameters: {}, data: {} };
    ...
    trial(displayElement) {
      ...
      form.addEventListener("submit", (event) => {
        ...
        this.jsPsych.finishTrial(Object.assign({
