(function (global) {
  ...
  function fatal(error) {
    console.error("Animal and artifact purpose study initialization error", error);
    const target = document.getElementById("jspsych-target");
    target.innerHTML = '<main class="study-screen completion-screen"><section class="completion-card error-card" role="alert">' +
      '<h1>The study could not start.</h1><p>Please reopen index.html from the complete animal_goodness_v7 folder.</p>' +
