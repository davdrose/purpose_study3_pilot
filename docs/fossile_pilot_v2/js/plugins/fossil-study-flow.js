(function () {
  ...
  class FossilConsentPlugin {
    static info = { name: "fossil-consent", version: "20.0.0", parameters: {}, data: {} };
  ...
  class FossilStudyIntroductionPlugin {
    static info = { name: "fossil-study-introduction", version: "20.0.0", parameters: {}, data: {} };
  ...
  class FossilDemographicsPlugin {
    static info = { name: "fossil-demographics", version: "20.0.0", parameters: {}, data: {} };
