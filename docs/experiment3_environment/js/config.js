(function () {
  ...
  const STUDY_VERSION = "experiment3_environment-1.0.0";
  ...
  const featureTypes = ["purpose", "environmental_exposure"];
  ...
  const getLocalAssignmentKey = () => {
    const storageKey = "purpose-categorization-environment-assignment";
    try {
