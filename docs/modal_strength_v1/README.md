# Modal Strength Study — v3

This is a self-contained jsPsych prototype based on `modal_strength_v2`. Open `index.html` directly or serve this folder from any static web server.
...
- Each animal appears on one screen with its image and the statement: “[Animals] must exist for some purpose.”
