(function (global) {
  ...
  function questionText(animal) {
    const capitalized = animal.plural.charAt(0).toUpperCase() + animal.plural.slice(1);
    return C.question.template.replaceAll("{Plural}", capitalized);
  }

  class ConsentPlugin {
    static info = { name: "modal-strength-consent", version: "3.0.0", parameters: {}, data: {} };
    ...
    trial(displayElement) {
      ...
      displayElement.innerHTML = studyFrame(
        ...
        '<div class="consent-document" tabindex="0">' +
          '<p>Thank you for agreeing to take part in this study. We appreciate your time and effort. In this study, you will see four kinds of animals, and then we will ask you to answer one brief question about each of them. The questions have no right or wrong answers—we’re just exploring features of human psychology in this research. You will be paid $0.60 for your time and efforts. We do not anticipate any risks from participating in this research. While you will not directly benefit from taking part in this research study, we hope society and the scientific community will benefit from the knowledge gained about human psychology and judgment.</p>' +
  ...
  class IntroductionPlugin {
    static info = { name: "modal-strength-introduction", version: "3.0.0", parameters: {}, data: {} };
    ...
    trial(displayElement) {
      ...
      displayElement.innerHTML = studyFrame(
        ...
        '<div class="instructions-body">' +
          '<p>You will see <strong>four different animals</strong>, one at a time and in random order.</p>' +
          '<p>For each animal, you will see its picture and answer one <strong>Yes</strong> or <strong>No</strong> question about it.</p>' +
  ...
  class DemographicsPlugin {
    static info = { name: "modal-strength-demographics", version: "3.0.0", parameters: {}, data: {} };
